...
LDFLAGS.zlib = 
LDFLAGS.math = -lm
LDFLAGS.rpath = -Wl,-rpath,/root/sqlite_exp/sqlite-autoconf-3500400/inst/lib
LDFLAGS.pthread = 
LDFLAGS.dlopen = 
LDFLAGS.readline = 
CFLAGS.readline = 
...
#
AS_AUTORECONFIG = cd "/root/sqlite_exp/sqlite-autoconf-3500400" && ./configure --prefix=/root/sqlite_exp/sqlite-autoconf-3500400/inst "CFLAGS=-O0 -g3" "CXXFLAGS=-O0 -g3"
